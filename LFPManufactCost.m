...
if SOH2 == 1
    Cost_Manu = 630/6.5*Cell_kWh*ModTotCell*ModParaCell*PacTotMod;
else
    ...
    if SOH2==0.8
        adc = max(SOHsum1)/C_battery_avarage;
        %%%%%%%%%%%%%%% LFP 70%SOH %%%%%%%%%%%%%%%
    elseif SOH2==0.7
        SOHsum3=zeros(1,6000);
        SOH = 0.7;
        for i = 2:6000
            if SOH >= 0.4
                cycle = i+2856;
    ...
    elseif SOH2==0.9
        ...
        adc = max(SOHsum4)/C_battery_avarage*0.88/0.9;
    end
%     Cost_Manu = 50/65*(50+30*(134000000)^(0.95-1)*0.6^0.05)*1.0*Cell_kWh*SOH2*ModTotCell*ModParaCell*PacTotMod*adc;
Cost_Manu = (19+25*(134000000)^(0.95-1)*0.6^0.05)*1.0*Cell_kWh*SOH2*ModTotCell*ModParaCell*PacTotMod*adc;
end
