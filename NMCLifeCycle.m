...
%             CO2_Hydro_kWh,CO2_Direct_kWh,CO2_Pyro_kWh,Cost_Hydro_kWh,Cost_Direct_kWh,Cost_Pyro_kWh] = NMCManufact(Mode,SOH1,SOH2)
function [BattEner,CO2_Cell_kWh,CO2_Manu_kWh,Cost_Manu_kWh,CO2_Use_kWh,Cost_Use_kWh,CO2_Use_kWh_year,Cost_Use_kWh_year,CO2_Use_year,Cost_Use_year,...
            ...
            Cost_PacRec,Cost_Hydro,Cost_Direct,Cost_Pyro] = NMCLifeCycle(Mode,SOH1,SOH2)


run NMCCellDesign.m;
run NMCModuleDesign.m;
run NMCPackDesign.m;
...
CO2_Manu_kWh = sum(CO2_Manu)/BattEner;
