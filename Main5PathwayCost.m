...
for i=1:35
    ...
    elseif B(i,1) == 5
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "ESS-Gov" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 6
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "ESS-Gov" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 7
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "ESS-Gov" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 8
        Pathway_NMC_Cost_Direct(i,:) = ["ESS2" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 9
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "ESS-Lig" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 10
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "ESS-Lig" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 11
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "ESS-Lig" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 12
        Pathway_NMC_Cost_Direct(i,:) = ["ESS3" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 13
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "ESS-Com" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 14
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "ESS-Com" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 15
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "ESS-Com" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 16
        Pathway_NMC_Cost_Direct(i,:) = ["CBS1" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 17
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Com" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 18
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Com" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 19
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Com" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 20
        Pathway_NMC_Cost_Direct(i,:) = ["CBS2" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 21
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Rai" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 22
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Rai" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 23
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Rai" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 24
        Pathway_NMC_Cost_Direct(i,:) = ["CBS3" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 25
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Urb" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 26
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Urb" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 27
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Urb" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 28
        Pathway_NMC_Cost_Direct(i,:) = ["CBS4" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 29
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Rur" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 30
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Rur" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 31
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Rur" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 32
        Pathway_NMC_Cost_Direct(i,:) = ["LSV" "100%" "No" "-" "-" "Direct" A(i,1)];
    elseif B(i,1) == 33
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "90%" "Yes" "LSV-Sig" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 34
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "80%" "Yes" "LSV-Sig" "40%" "Direct" A(i,1)];
    elseif B(i,1) == 35
        Pathway_NMC_Cost_Direct(i,:) = ["EV" "70%" "Yes" "LSV-Sig" "40%" "Direct" A(i,1)];
    end
end
...
for i=1:35
    ...
    elseif D(i,1) == 5
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "ESS-Gov" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 6
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "ESS-Gov" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 7
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "ESS-Gov" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 8
        Pathway_NMC_Cost_Hydro(i,:) = ["ESS2" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 9
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "ESS-Lig" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 10
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "ESS-Lig" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 11
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "ESS-Lig" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 12
        Pathway_NMC_Cost_Hydro(i,:) = ["ESS3" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 13
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "ESS-Com" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 14
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "ESS-Com" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 15
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "ESS-Com" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 16
        Pathway_NMC_Cost_Hydro(i,:) = ["CBS1" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 17
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Com" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 18
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Com" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 19
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Com" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 20
        Pathway_NMC_Cost_Hydro(i,:) = ["CBS2" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 21
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Rai" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 22
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Rai" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 23
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Rai" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 24
        Pathway_NMC_Cost_Hydro(i,:) = ["CBS3" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 25
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Urb" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 26
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Urb" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 27
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Urb" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 28
        Pathway_NMC_Cost_Hydro(i,:) = ["CBS4" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 29
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Rur" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 30
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Rur" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 31
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Rur" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 32
        Pathway_NMC_Cost_Hydro(i,:) = ["LSV" "100%" "No" "-" "-" "Hydro-" C(i,1)];
    elseif D(i,1) == 33
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "LSV-Sig" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 34
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "LSV-Sig" "40%" "Hydro-" C(i,1)];
    elseif D(i,1) == 35
        Pathway_NMC_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "LSV-Sig" "40%" "Hydro-" C(i,1)];
    end
end
%%%%%%%%% Pyro-recycling 
...
for i=1:35
    ...
    elseif F(i,1) == 5
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "ESS-Gov" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 6
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "ESS-Gov" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 7
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "ESS-Gov" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 8
        Pathway_NMC_Cost_Pyro(i,:) = ["ESS2" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 9
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "ESS-Lig" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 10
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "ESS-Lig" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 11
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "ESS-Lig" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 12
        Pathway_NMC_Cost_Pyro(i,:) = ["ESS3" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 13
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "ESS-Com" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 14
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "ESS-Com" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 15
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "ESS-Com" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 16
        Pathway_NMC_Cost_Pyro(i,:) = ["CBS1" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 17
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Com" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 18
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Com" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 19
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Com" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 20
        Pathway_NMC_Cost_Pyro(i,:) = ["CBS2" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 21
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Rai" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 22
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Rai" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 23
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Rai" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 24
        Pathway_NMC_Cost_Pyro(i,:) = ["CBS3" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 25
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Urb" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 26
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Urb" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 27
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Urb" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 28
        Pathway_NMC_Cost_Pyro(i,:) = ["CBS4" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 29
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Rur" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 30
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Rur" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 31
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Rur" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 32
        Pathway_NMC_Cost_Pyro(i,:) = ["LSV" "100%" "No" "-" "-" "Pyro-" E(i,1)];
    elseif F(i,1) == 33
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "LSV-Sig" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 34
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "LSV-Sig" "40%" "Pyro-" E(i,1)];
    elseif F(i,1) == 35
        Pathway_NMC_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "LSV-Sig" "40%" "Pyro-" E(i,1)];
    end
end
Pathway_NMC_Cost = [Pathway_NMC_Cost_Direct;Pathway_NMC_Cost_Hydro;Pathway_NMC_Cost_Pyro];
...
for i=1:35
    ...
    elseif H(i,1) == 5
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "ESS-Gov" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 6
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "ESS-Gov" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 7
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "ESS-Gov" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 8
        Pathway_LFP_Cost_Direct(i,:) = ["ESS2" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 9
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "ESS-Lig" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 10
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "ESS-Lig" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 11
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "ESS-Lig" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 12
        Pathway_LFP_Cost_Direct(i,:) = ["ESS3" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 13
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "ESS-Com" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 14
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "ESS-Com" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 15
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "ESS-Com" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 16
        Pathway_LFP_Cost_Direct(i,:) = ["CBS1" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 17
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Com" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 18
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Com" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 19
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Com" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 20
        Pathway_LFP_Cost_Direct(i,:) = ["CBS2" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 21
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Rai" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 22
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Rai" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 23
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Rai" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 24
        Pathway_LFP_Cost_Direct(i,:) = ["CBS3" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 25
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Urb" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 26
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Urb" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 27
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Urb" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 28
        Pathway_LFP_Cost_Direct(i,:) = ["CBS4" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 29
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "CBS-Rur" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 30
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "CBS-Rur" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 31
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "CBS-Rur" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 32
        Pathway_LFP_Cost_Direct(i,:) = ["LSV" "100%" "No" "-" "-" "Direct" G(i,1)];
    elseif H(i,1) == 33
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "90%" "Yes" "LSV-Sig" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 34
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "80%" "Yes" "LSV-Sig" "40%" "Direct" G(i,1)];
    elseif H(i,1) == 35
        Pathway_LFP_Cost_Direct(i,:) = ["EV" "70%" "Yes" "LSV-Sig" "40%" "Direct" G(i,1)];
    end
end
%%%%%%%% Hydro- recycling
...
for i=1:35
    ...
    elseif J(i,1) == 5
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "ESS-Gov" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 6
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "ESS-Gov" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 7
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "ESS-Gov" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 8
        Pathway_LFP_Cost_Hydro(i,:) = ["ESS2" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 9
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "ESS-Lig" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 10
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "ESS-Lig" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 11
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "ESS-Lig" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 12
        Pathway_LFP_Cost_Hydro(i,:) = ["ESS3" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 13
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "ESS-Com" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 14
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "ESS-Com" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 15
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "ESS-Com" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 16
        Pathway_LFP_Cost_Hydro(i,:) = ["CBS1" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 17
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Com" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 18
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Com" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 19
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Com" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 20
        Pathway_LFP_Cost_Hydro(i,:) = ["CBS2" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 21
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Rai" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 22
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Rai" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 23
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Rai" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 24
        Pathway_LFP_Cost_Hydro(i,:) = ["CBS3" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 25
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Urb" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 26
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Urb" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 27
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Urb" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 28
        Pathway_LFP_Cost_Hydro(i,:) = ["CBS4" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 29
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "CBS-Rur" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 30
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "CBS-Rur" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 31
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "CBS-Rur" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 32
        Pathway_LFP_Cost_Hydro(i,:) = ["LSV" "100%" "No" "-" "-" "Hydro-" I(i,1)];
    elseif J(i,1) == 33
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "90%" "Yes" "LSV-Sig" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 34
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "80%" "Yes" "LSV-Sig" "40%" "Hydro-" I(i,1)];
    elseif J(i,1) == 35
        Pathway_LFP_Cost_Hydro(i,:) = ["EV" "70%" "Yes" "LSV-Sig" "40%" "Hydro-" I(i,1)];
    end
end
%%%%%%%% Pyro- recycling
...
for i=1:35
    ...
    elseif L(i,1) == 5
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "ESS-Gov" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 6
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "ESS-Gov" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 7
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "ESS-Gov" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 8
        Pathway_LFP_Cost_Pyro(i,:) = ["ESS2" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 9
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "ESS-Lig" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 10
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "ESS-Lig" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 11
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "ESS-Lig" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 12
        Pathway_LFP_Cost_Pyro(i,:) = ["ESS3" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 13
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "ESS-Com" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 14
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "ESS-Com" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 15
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "ESS-Com" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 16
        Pathway_LFP_Cost_Pyro(i,:) = ["CBS1" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 17
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Com" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 18
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Com" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 19
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Com" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 20
        Pathway_LFP_Cost_Pyro(i,:) = ["CBS2" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 21
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Rai" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 22
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Rai" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 23
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Rai" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 24
        Pathway_LFP_Cost_Pyro(i,:) = ["CBS3" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 25
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Urb" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 26
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Urb" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 27
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Urb" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 28
        Pathway_LFP_Cost_Pyro(i,:) = ["CBS4" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 29
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "CBS-Rur" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 30
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "CBS-Rur" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 31
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "CBS-Rur" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 32
        Pathway_LFP_Cost_Pyro(i,:) = ["LSV" "100%" "No" "-" "-" "Pyro-" K(i,1)];
    elseif L(i,1) == 33
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "90%" "Yes" "LSV-Sig" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 34
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "80%" "Yes" "LSV-Sig" "40%" "Pyro-" K(i,1)];
    elseif L(i,1) == 35
        Pathway_LFP_Cost_Pyro(i,:) = ["EV" "70%" "Yes" "LSV-Sig" "40%" "Pyro-" K(i,1)];
    end
end
Pathway_LFP_Cost = [Pathway_LFP_Cost_Direct;Pathway_LFP_Cost_Hydro;Pathway_LFP_Cost_Pyro];
