...
NMC_CO2_Direct_cummu = [NMC_CO2_Direct_cummu(:,1),NMC_CO2_Direct_cummu(:,1)+NMC_CO2_Direct_cummu(:,2),NMC_CO2_Direct_cummu(:,1)+NMC_CO2_Direct_cummu(:,2)+NMC_CO2_Direct_cummu(:,3),...
    NMC_CO2_Direct_cummu(:,1)+NMC_CO2_Direct_cummu(:,2)+NMC_CO2_Direct_cummu(:,3)+NMC_CO2_Direct_cummu(:,4),NMC_CO2_Direct_cummu(:,1)+NMC_CO2_Direct_cummu(:,2)+NMC_CO2_Direct_cummu(:,3)+NMC_CO2_Direct_cummu(:,4)+NMC_CO2_Direct_cummu(:,5)];
%%%%%%%%% hydro recycling %%%%%%%%%%%%%
...
for ii = 1:35
    if mod(ii,4) == 1
        if ii == 1
            ...
            NMC_CO2_Hydro_ele(1,:) = NMC_CO2_Hydro_ele(1,:)/SOHsum(1,1);
            NMC_CO2_Pyro_ele(1,:) = NMC_CO2_Pyro_ele(1,:)/SOHsum(1,1);
        else
            NMC_CO2_Direct_ele(ii,:) = NMC_CO2_Direct_ele(ii,:)/(SOHsum(4,1)-SOHsum(1,1));
            NMC_CO2_Hydro_ele(ii,:) = NMC_CO2_Hydro_ele(ii,:)/(SOHsum(4,1)-SOHsum(1,1));
            NMC_CO2_Pyro_ele(ii,:) = NMC_CO2_Pyro_ele(ii,:)/(SOHsum(4,1)-SOHsum(1,1));
        end
    elseif mod(ii,4) == 2
        if ii == 2
            ...
            NMC_CO2_Direct_ele(ii,:) = NMC_CO2_Direct_ele(ii,:)/(SOHsum(4,1)-SOHsum(2,1));
            NMC_CO2_Hydro_ele(ii,:) = NMC_CO2_Hydro_ele(ii,:)/(SOHsum(4,1)-SOHsum(2,1));
            NMC_CO2_Pyro_ele(ii,:) = NMC_CO2_Pyro_ele(ii,:)/(SOHsum(4,1)-SOHsum(2,1));
        end
    elseif mod(ii,4) == 3
        if ii == 3
            ...
            NMC_CO2_Direct_ele(ii,:) = NMC_CO2_Direct_ele(ii,:)/(SOHsum(4,1)-SOHsum(3,1));
            NMC_CO2_Hydro_ele(ii,:) = NMC_CO2_Hydro_ele(ii,:)/(SOHsum(4,1)-SOHsum(3,1));
            NMC_CO2_Pyro_ele(ii,:) = NMC_CO2_Pyro_ele(ii,:)/(SOHsum(4,1)-SOHsum(3,1));
        end
    else 
...
for i=1:35
    ...
    elseif N(i,1) == 5
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "ESS1" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 6
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "ESS1" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 7
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "ESS1" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 8
        Pathway_NMC_CO2_Direct(i,:) = ["ESS2" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 9
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "ESS2" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 10
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "ESS2" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 11
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "ESS2" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 12
        Pathway_NMC_CO2_Direct(i,:) = ["ESS3" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 13
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "ESS3" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 14
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "ESS3" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 15
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "ESS3" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 16
        Pathway_NMC_CO2_Direct(i,:) = ["CBS1" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 17
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS1" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 18
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS1" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 19
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS1" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 20
        Pathway_NMC_CO2_Direct(i,:) = ["CBS2" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 21
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS2" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 22
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS2" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 23
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS2" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 24
        Pathway_NMC_CO2_Direct(i,:) = ["CBS3" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 25
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS3" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 26
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS3" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 27
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS3" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 28
        Pathway_NMC_CO2_Direct(i,:) = ["CBS4" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 29
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS4" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 30
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS4" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 31
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS4" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 32
        Pathway_NMC_CO2_Direct(i,:) = ["LSV" "100%" "No" "-" "-" "Direct" M(i,1)];
    elseif N(i,1) == 33
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "90%" "Yes" "LSV" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 34
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "80%" "Yes" "LSV" "40%" "Direct" M(i,1)];
    elseif N(i,1) == 35
        Pathway_NMC_CO2_Direct(i,:) = ["EV" "70%" "Yes" "LSV" "40%" "Direct" M(i,1)];
    end
end
%%%%%%%% Hydro- recycling
...
for i=1:35
    ...
    elseif P(i,1) == 5
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "ESS1" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 6
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "ESS1" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 7
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "ESS1" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 8
        Pathway_NMC_CO2_Hydro(i,:) = ["ESS2" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 9
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "ESS2" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 10
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "ESS2" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 11
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "ESS2" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 12
        Pathway_NMC_CO2_Hydro(i,:) = ["ESS3" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 13
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "ESS3" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 14
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "ESS3" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 15
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "ESS3" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 16
        Pathway_NMC_CO2_Hydro(i,:) = ["CBS1" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 17
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS1" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 18
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS1" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 19
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS1" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 20
        Pathway_NMC_CO2_Hydro(i,:) = ["CBS2" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 21
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS2" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 22
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS2" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 23
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS2" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 24
        Pathway_NMC_CO2_Hydro(i,:) = ["CBS3" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 25
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS3" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 26
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS3" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 27
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS3" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 28
        Pathway_NMC_CO2_Hydro(i,:) = ["CBS4" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 29
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS4" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 30
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS4" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 31
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS4" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 32
        Pathway_NMC_CO2_Hydro(i,:) = ["LSV" "100%" "No" "-" "-" "Hydro-" O(i,1)];
    elseif P(i,1) == 33
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "LSV" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 34
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "LSV" "40%" "Hydro-" O(i,1)];
    elseif P(i,1) == 35
        Pathway_NMC_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "LSV" "40%" "Hydro-" O(i,1)];
    end
end
%%%%%%%%% Pyro- recycling
...
for i=1:35
    ...
    elseif R(i,1) == 5
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "ESS1" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 6
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "ESS1" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 7
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "ESS1" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 8
        Pathway_NMC_CO2_Pyro(i,:) = ["ESS2" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 9
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "ESS2" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 10
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "ESS2" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 11
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "ESS2" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 12
        Pathway_NMC_CO2_Pyro(i,:) = ["ESS3" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 13
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "ESS3" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 14
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "ESS3" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 15
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "ESS3" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 16
        Pathway_NMC_CO2_Pyro(i,:) = ["CBS1" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 17
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS1" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 18
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS1" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 19
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS1" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 20
        Pathway_NMC_CO2_Pyro(i,:) = ["CBS2" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 21
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS2" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 22
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS2" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 23
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS2" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 24
        Pathway_NMC_CO2_Pyro(i,:) = ["CBS3" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 25
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS3" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 26
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS3" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 27
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS3" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 28
        Pathway_NMC_CO2_Pyro(i,:) = ["CBS4" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 29
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS4" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 30
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS4" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 31
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS4" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 32
        Pathway_NMC_CO2_Pyro(i,:) = ["LSV" "100%" "No" "-" "-" "Pyro-" Q(i,1)];
    elseif R(i,1) == 33
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "LSV" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 34
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "LSV" "40%" "Pyro-" Q(i,1)];
    elseif R(i,1) == 35
        Pathway_NMC_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "LSV" "40%" "Pyro-" Q(i,1)];
    end
end
...
LFP_CO2_Hydro_cummu = [DataLFPbar(:,1),DataLFPbar(:,1)+DataLFPbar(:,2),DataLFPbar(:,1)+DataLFPbar(:,2)+DataLFPbar(:,3),...
     DataLFPbar(:,1)+DataLFPbar(:,2)+DataLFPbar(:,3)+DataLFPbar(:,4),DataLFPbar(:,1)+DataLFPbar(:,2)+DataLFPbar(:,3)+DataLFPbar(:,4)+DataLFPbar(:,5)];
%%%%%%%%%% pyro recycling %%%%%%%%%%%%%%%
...
LFP_CO2_Pyro_cummu = [DataLFPbar(:,1),DataLFPbar(:,1)+DataLFPbar(:,2),DataLFPbar(:,1)+DataLFPbar(:,2)+DataLFPbar(:,3),...
    DataLFPbar(:,1)+DataLFPbar(:,2)+DataLFPbar(:,3)+DataLFPbar(:,4),DataLFPbar(:,1)+DataLFPbar(:,2)+DataLFPbar(:,3)+DataLFPbar(:,4)+DataLFPbar(:,5)];
...
for ii = 1:35
    if mod(ii,4) == 1
        if ii == 1
            ...
            LFP_CO2_Direct_ele(ii,:) = LFP_CO2_Direct_ele(ii,:)/(SOHsum(4,1)-SOHsum(1,1));
            LFP_CO2_Hydro_ele(ii,:) = LFP_CO2_Hydro_ele(ii,:)/(SOHsum(4,1)-SOHsum(1,1));
            LFP_CO2_Pyro_ele(ii,:) = LFP_CO2_Pyro_ele(ii,:)/(SOHsum(4,1)-SOHsum(1,1));
        end
    elseif mod(ii,4) == 2
        if ii == 2
            ...
            LFP_CO2_Direct_ele(ii,:) = LFP_CO2_Direct_ele(ii,:)/(SOHsum(4,1)-SOHsum(2,1));
            LFP_CO2_Hydro_ele(ii,:) = LFP_CO2_Hydro_ele(ii,:)/(SOHsum(4,1)-SOHsum(2,1));
            LFP_CO2_Pyro_ele(ii,:) = LFP_CO2_Pyro_ele(ii,:)/(SOHsum(4,1)-SOHsum(2,1));
        end
    elseif mod(ii,4) == 3
        if ii == 3
            ...
            LFP_CO2_Direct_ele(ii,:) = LFP_CO2_Direct_ele(ii,:)/(SOHsum(4,1)-SOHsum(3,1));
            LFP_CO2_Hydro_ele(ii,:) = LFP_CO2_Hydro_ele(ii,:)/(SOHsum(4,1)-SOHsum(3,1));
            LFP_CO2_Pyro_ele(ii,:) = LFP_CO2_Pyro_ele(ii,:)/(SOHsum(4,1)-SOHsum(3,1));
        end
    else 
...
for i=1:35
    ...
    elseif T(i,1) == 5
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "ESS1" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 6
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "ESS1" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 7
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "ESS1" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 8
        Pathway_LFP_CO2_Direct(i,:) = ["ESS2" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 9
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "ESS2" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 10
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "ESS2" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 11
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "ESS2" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 12
        Pathway_LFP_CO2_Direct(i,:) = ["ESS3" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 13
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "ESS3" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 14
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "ESS3" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 15
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "ESS3" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 16
        Pathway_LFP_CO2_Direct(i,:) = ["CBS1" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 17
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS1" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 18
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS1" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 19
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS1" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 20
        Pathway_LFP_CO2_Direct(i,:) = ["CBS2" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 21
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS2" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 22
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS2" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 23
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS2" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 24
        Pathway_LFP_CO2_Direct(i,:) = ["CBS3" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 25
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS3" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 26
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS3" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 27
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS3" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 28
        Pathway_LFP_CO2_Direct(i,:) = ["CBS4" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 29
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "CBS4" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 30
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "CBS4" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 31
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "CBS4" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 32
        Pathway_LFP_CO2_Direct(i,:) = ["LSV" "100%" "No" "-" "-" "Direct" S(i,1)];
    elseif T(i,1) == 33
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "90%" "Yes" "LSV" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 34
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "80%" "Yes" "LSV" "40%" "Direct" S(i,1)];
    elseif T(i,1) == 35
        Pathway_LFP_CO2_Direct(i,:) = ["EV" "70%" "Yes" "LSV" "40%" "Direct" S(i,1)];
    end
end
%%%%%%%%% Hydro- recycling
...
for i=1:35
    ...
    elseif V(i,1) == 5
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "ESS1" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 6
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "ESS1" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 7
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "ESS1" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 8
        Pathway_LFP_CO2_Hydro(i,:) = ["ESS2" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 9
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "ESS2" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 10
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "ESS2" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 11
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "ESS2" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 12
        Pathway_LFP_CO2_Hydro(i,:) = ["ESS3" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 13
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "ESS3" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 14
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "ESS3" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 15
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "ESS3" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 16
        Pathway_LFP_CO2_Hydro(i,:) = ["CBS1" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 17
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS1" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 18
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS1" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 19
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS1" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 20
        Pathway_LFP_CO2_Hydro(i,:) = ["CBS2" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 21
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS2" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 22
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS2" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 23
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS2" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 24
        Pathway_LFP_CO2_Hydro(i,:) = ["CBS3" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 25
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS3" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 26
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS3" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 27
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS3" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 28
        Pathway_LFP_CO2_Hydro(i,:) = ["CBS4" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 29
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "CBS4" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 30
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "CBS4" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 31
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "CBS4" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 32
        Pathway_LFP_CO2_Hydro(i,:) = ["LSV" "100%" "No" "-" "-" "Hydro-" U(i,1)];
    elseif V(i,1) == 33
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "90%" "Yes" "LSV" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 34
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "80%" "Yes" "LSV" "40%" "Hydro-" U(i,1)];
    elseif V(i,1) == 35
        Pathway_LFP_CO2_Hydro(i,:) = ["EV" "70%" "Yes" "LSV" "40%" "Hydro-" U(i,1)];
    end
end
%%%%%%%%% Pyro- recycling
...
for i=1:35
    ...
    elseif X(i,1) == 5
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "ESS1" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 6
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "ESS1" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 7
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "ESS1" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 8
        Pathway_LFP_CO2_Pyro(i,:) = ["ESS2" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 9
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "ESS2" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 10
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "ESS2" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 11
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "ESS2" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 12
        Pathway_LFP_CO2_Pyro(i,:) = ["ESS3" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 13
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "ESS3" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 14
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "ESS3" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 15
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "ESS3" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 16
        Pathway_LFP_CO2_Pyro(i,:) = ["CBS1" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 17
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS1" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 18
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS1" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 19
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS1" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 20
        Pathway_LFP_CO2_Pyro(i,:) = ["CBS2" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 21
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS2" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 22
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS2" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 23
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS2" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 24
        Pathway_LFP_CO2_Pyro(i,:) = ["CBS3" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 25
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS3" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 26
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS3" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 27
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS3" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 28
        Pathway_LFP_CO2_Pyro(i,:) = ["CBS4" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 29
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "CBS4" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 30
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "CBS4" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 31
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "CBS4" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 32
        Pathway_LFP_CO2_Pyro(i,:) = ["LSV" "100%" "No" "-" "-" "Pyro-" W(i,1)];
    elseif X(i,1) == 33
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "90%" "Yes" "LSV" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 34
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "80%" "Yes" "LSV" "40%" "Pyro-" W(i,1)];
    elseif X(i,1) == 35
        Pathway_LFP_CO2_Pyro(i,:) = ["EV" "70%" "Yes" "LSV" "40%" "Pyro-" W(i,1)];
    end
end