...
PosAcWt = 0.89; % active materials mass composition (NCM)
PosCBWt = 0.06; % Carbon black mass composition
PosBDWt = 0.05; % Binder mass composition (PVDF)
PosAcRo = 4.65; % active materials density (NCM), g/cc
PosCBRo = 1.825; % Carbon black density, g/cc
PosBDRo = 1.77; % Binder mass density (PVDF), g/cc
PosPoro = 0.32; % Porosity
PosSpCap = 180; % Specific capacity (NCM622), mAh/g
PosArCap = 3.06; % Areal Capacity, mAh/cm^2
...
PosEtdW = 79; % Postive electrode width, mm
