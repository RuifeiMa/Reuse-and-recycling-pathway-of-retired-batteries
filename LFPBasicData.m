...
%%%%%%%%% Energy %%%%%
CO2_Elec = 0.7488; % Electricity, kg CO2 eq / kWh
% 2020(Base):0.7488; 2030(Base):0.7366; 2040(Base):0.6939;
% 2050(Base):0.6490
% 2030(RCP2.6):0.5501; 2040(RCP2.6):0.3140; 2050(RCP2.6):0.3367
...
%%%%%%%%% Cell %%%%%
%%%%%%%%% Cathode %%%%%
CO2_PosAc = 9.3881414; % Cathode active material, kg CO2 eq / kg
...
CO2_H2O2_mar = 1.4111259; %%%%%%%%%%%LFP
CO2_FePO4_pro = 6.2405375; %%%%%%%%LFP
CO2_LiFePO4_pro = 6.2405375; %%%%%%%%%LFP
...
%%%%%%%%% Hydro %%%%%
CO2_Hydro_Input = [CO2_H2SO4_mar CO2_H2O2_mar CO2_Na2CO3_mar CO2_water_mar CO2_Elec];
CO2_Hydro_Output = [CO2_Li2CO3_pro CO2_FePO4_pro CO2_Graphite_pro CO2_Al_pro CO2_Cu_pro];

%%%%%%%%% Direct %%%%%
CO2_Direct_Input = [CO2_Li2CO3_mar CO2_water_mar CO2_Elec];
CO2_Direct_Output = [CO2_LiFePO4_pro CO2_Graphite_pro CO2_Al_pro CO2_Cu_pro];

%%%%%%%%% Pyro %%%%%
CO2_Pyro_Input = [CO2_H2SO4_mar CO2_Coke_mar CO2_Na2CO3_mar CO2_water_mar CO2_Elec];
CO2_Pyro_Output = [CO2_Li2CO3_pro CO2_Graphite_pro CO2_Al_pro CO2_Cu_pro];
...
Cost_Trans = 500/ExchangeRate/1000; % Transportation, $
...
Cost_DegradLFP = 38750/ExchangeRate/1000; %%%%%%%%%%LFP
Cost_H2O2 = 4200/ExchangeRate/1000; %%%%%%%%%LFP
Cost_FePO4 = 35800/ExchangeRate/1000; %%%%%%%%LFP
Cost_LiFePO4 = 81500/ExchangeRate/1000; %%%%%%%%LFP
Cost_H2SO4 = 550/ExchangeRate/1000; % carbon emission of 1 kg H2SO4, kg CO2 eq / kg
...
Cost_NMC622 = 244000/ExchangeRate/1000;
...
Cost_Hydro_Input = [Cost_DegradLFP Cost_H2SO4 Cost_H2O2 Cost_Na2CO3 Cost_water Cost_Elec ...
    Cost_Equip_Hydro Cost_Labor_Hydro Cost_Disass_Hydro Cost_Sewage_Hydro];
Cost_Hydro_Output = [Cost_Li2CO3 Cost_FePO4 Cost_Graphite Cost_Al Cost_Cu];
%%%%%%%%% Direct %%%%%
...
Cost_Direct_Input = [Cost_DegradLFP Cost_Li2CO3 Cost_water Cost_Elec ...
    Cost_Equip_Direct Cost_Labor_Direct Cost_Disass_Direct Cost_Sewage_Direct];
Cost_Direct_Output = [Cost_LiFePO4 Cost_Graphite Cost_Al Cost_Cu];
%%%%%%%%% Pyro %%%%%
...
Cost_Pyro_Input = [Cost_DegradLFP Cost_H2SO4 Cost_Coke Cost_Na2CO3 Cost_water Cost_Elec ...
    Cost_Equip_Pyro Cost_Labor_Pyro Cost_Disass_Pyro Cost_Sewage_Pyro];
Cost_Pyro_Output = [Cost_Li2CO3 Cost_Graphite Cost_Al Cost_Cu];
