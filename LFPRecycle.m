...
CO2_Hydro = [CO2_Hydro_Input -CO2_Hydro_Output].* ...
    [PosAcMass/1000/157.76*SOH1/2*98 PosAcMass/1000/157.76*SOH1*17 PosAcMass/1000/157.76*SOH1/2*106 CellTotMass/1000*500 CellTotMass/1000/1000*500 ...
    PosAcMass/1000/157.76*SOH1/2*73.88*98/100 PosAcMass/1000/157.6*150.82*98/100 ...
    NegAcMass/1000/1000*95/100 (PosCCMass+PosTermMass)/1000*93/100 (NegCCMass+NegTermMass)/1000*93/100]*...
...
CO2_Direct = [CO2_Direct_Input -CO2_Direct_Output].* ...
    [PosAcMass/1000/157.76*(1-SOH1)/2*73.88 CellTotMass/1000*200 CellTotMass/1000/1000*300 ...
    PosAcMass/1000/157.76*157.76*90/100 NegAcMass/1000*90/100 (PosCCMass+PosTermMass)/1000*90/100 (NegCCMass+NegTermMass)/1000*90/100]* ...
    ModTotCell*ModParaCell*PacTotMod;
CO2_Direct_kWh = (sum(CO2_PacRec)+sum(CO2_Direct))/BattEner;
%%%%%%%%% Pyro %%%%%
CO2_Pyro = [CO2_Pyro_Input -CO2_Pyro_Output].* ...
    [((SOH1/2+1)*PosAcMass/1000/157.76+(PosCCMass+PosTermMass)/1000/27*1.5+(NegCCMass+NegTermMass)/1000/63.546)*98 CellTotMass/1000*0.025 PosAcMass/1000/157.76*SOH1/2*106 CellTotMass/1000*200 ...
    CellTotMass/1000/1000*1000 ...
    PosAcMass/1000/157.76*SOH1/2*73.88*94/100  ...
...
Cost_Hydro = [Cost_Hydro_Input -Cost_Hydro_Output].* ...
    [PosAcMass/1000 PosAcMass/1000/157.76*SOH1/2*98 PosAcMass/1000/157.76*SOH1/2*34 PosAcMass/1000/157.76*SOH1/2*106 CellTotMass/1000*500 CellTotMass/1000/1000*500 ...
    CellTotMass/1000 CellTotMass/1000 CellTotMass/1000 CellTotMass/1000 ...
    PosAcMass/1000/157.76*SOH1/2*73.88*98/100 PosAcMass/1000/157.76*150.82*98/100 ...
    NegAcMass/1000/1000*95/100 (PosCCMass+PosTermMass)/1000*93/100 (NegCCMass+NegTermMass)/1000*93/100]* ...
    ModTotCell*ModParaCell*PacTotMod;
Cost_Hydro_kWh = (sum(Cost_PacRec)+sum(Cost_Hydro))/BattEner;
%%%%%%%%% Direct %%%%%
Cost_Direct = [Cost_Direct_Input -Cost_Direct_Output].* ...
    [PosAcMass/1000 PosAcMass/1000/157.76*(1-SOH1)/2*73.88 CellTotMass/1000*200 CellTotMass/1000/1000*300 ...
    CellTotMass/1000 CellTotMass/1000 CellTotMass/1000 CellTotMass/1000 ...
    PosAcMass/1000/157.76*157.76*90/100 NegAcMass/1000*90/100 (PosCCMass+PosTermMass)/1000*90/100 (NegCCMass+NegTermMass)/1000*90/100]* ...
    ModTotCell*ModParaCell*PacTotMod;
...
Cost_Pyro = [Cost_Pyro_Input -Cost_Pyro_Output].* ...
    [PosAcMass/1000 ((SOH1/2+1)*PosAcMass/1000/157.76+(PosCCMass+PosTermMass)/1000/27*1.5+(NegCCMass+NegTermMass)/1000/63.546)*98 CellTotMass/1000*0.025 PosAcMass/1000/157.76*SOH1/2*106 CellTotMass/1000*200 ...
    CellTotMass/1000/1000*1000 ...
    CellTotMass/1000 CellTotMass/1000 CellTotMass/1000 CellTotMass/1000 ...
    PosAcMass/1000/157.76*SOH1/2*73.88*94/100 ...
